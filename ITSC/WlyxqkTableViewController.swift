...
//    var indexOfItems: Int = 0
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "wlyxqkCell", for: indexPath) as! WebInfoTableViewCell
...
//            print(urlMain)
            ...
            url = URL(string: "https://itsc.nju.edu.cn/wlyxqk/list\(numOfPages).htm")!
        }
